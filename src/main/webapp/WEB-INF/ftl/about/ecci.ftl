...
<@c.page css="../resources/css/about-detail-page.css">
    ...
    <div class="container">
      ...
      <img src="../resources/images/logo-ECCI.png" alt="..." class="img-rounded img-responsive center-block">
      
        <h2>Escuela de Ciencias De La Computación E Informática - ECCI</h2>
