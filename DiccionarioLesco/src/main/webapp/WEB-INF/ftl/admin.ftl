...
<@c.page css="resources/css/admin.css" css2="resources/css/home.css" js="resources/js/admin.js">
    <!-- custom page content -->
    ...
    <div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="list-group">
				...
				<div class="row">
					<h1><span class="label label-primary terms-header">Categorías</span></h1>
				</div>
...
<!-- 				</div> -->
					...
					<ul class="list-group">	
					 ...
					 <#list listCategories as category>
						 <a class="list-group-item">
							<span id="${category.categoryId}" title="Eliminar" class="glyphicon glyphicon-remove confirmLink"></span> 
		    ...
		    <div class="panel panel-default">
			  <div class="panel-body">
				...
				<form class="form-horizontal" name="categoryForm" id="categoryForm" enctype="multipart/form-data">
					<fieldset>
