		  ...
		  <div class="row">
		    ...
		    <!--Como usar Tabs: http://getbootstrap.com/javascript/#tabs -->
			  ...
			  <ul class="nav nav-tabs" role="tablist">
			    <li role="presentation" class="active"><a href="#addTerm" aria-controls="addTerm" role="tab" data-toggle="tab">Agregar Término</a></li>
			    <li role="presentation"><a href="#requestTerm" aria-controls="requestTerm" role="tab" data-toggle="tab">Solicitar Término</a></li>
			  </ul>
			    ...
			    <div role="tabpanel" class="tab-pane" id="requestTerm">
			    	<div class="panel panel-default">
							  <div class="panel-body">
							  	...
							  	<form class="form-horizontal" name="requestTermForm" id="requestTermForm" enctype="multipart/form-data">
									<fieldset>
										...
										<div class="form-group">
										  <label class="col-md-4 control-label" for="textinput">Término</label>  
										  <div class="col-md-4">
										  <input id="requestedWordName" name="requestedWordName" placeholder="Término" class="form-control input-md" type="text" required="required">
										  </div>
										</div>
										...
										<div class="form-group">
										  ...
										  <div class="col-md-6">                     
										    <textarea class="form-control" placeholder="requestedDescription" id="requestedDescription" name="requestedDescription" required="required"></textarea>
										  </div>
										</div>
							  	...
							  	<div class="row">
							    	<div id="requestTermModal" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
									  <div class="modal-dialog modal-md" role="document">
									    <div class="modal-content text-center">
									      ¡Término Agregado Exitosamente!
									      <div class="modal-footer">
									        <div class="row">
									        	<div class="col-md-5 text-center">
									        		<a href="/DiccionarioLesco/agregar" class="btn btn-info" role="button">Solicitar Nuevo Término</a>
									        	</div>
									        	<div class="col-md-2"></div>
										        <div class="col-md-5 text-center">
										        	<a href="/DiccionarioLesco/" class="btn btn-info" role="button">Página Principal</a>
